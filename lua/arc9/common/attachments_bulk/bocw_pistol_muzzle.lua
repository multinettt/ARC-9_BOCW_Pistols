...
ARC9.LoadAttachment(ATT, "bocw_magnum_muzzle_suppressor")

ATT = {}

ATT.PrintName = "Magnum Muzzle 357"
ATT.CompactName = "M357 MUZZ"
...
ARC9.LoadAttachment(ATT, "bocw_magnum_muzzle_base") -- gg